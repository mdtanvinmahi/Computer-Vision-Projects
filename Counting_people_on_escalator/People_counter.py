...
classNames = ["person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat", "traffic light", "fire hydrant", "stop sign", "parking meter",
              ...
              "potted plant", "bed", "dining table", "toilet", "tv monitor", "laptop", "mouse", "remote", "keyboard", "cell phone", "microwave", "oven", "toaster", "sink",
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass == "person" and conf > 0.3:
                # It will not show the confidence level of anything except cars, bus and motorbike and also if the confidence level is above 0.3
